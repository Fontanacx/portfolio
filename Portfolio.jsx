        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ProjectCard 
              ...
              description="TaskBoarder es una plataforma intuitiva para organizar, priorizar y completar tus tareas diarias. Con un diseño limpio y funcional, te permite crear listas de tareas personalizadas, asignar fechas de vencimiento y marcar tareas completadas para mantener un control eficiente de tu productividad.
